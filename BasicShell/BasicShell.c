/*******************************************************************
    ...
    Started:  15.07.2019
	End    :  01.08.2019
	Description:  A simple unix shell program using C .
...
#include <unistd.h>     
#include <sys/wait.h>	
#include <fcntl.h>	// for creating a file
...
int shell_cd(char ** args){
	if (args[1] == NULL){
		fprintf(stderr, "mtozal: one argument required\n");
	}
...
// Function:  shell_exit
// status 0 to indicate termination
...
int shell_help(char ** args){
	printf("\nA simple unix shell program by Mücahit Tozal\n");
